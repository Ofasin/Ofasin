...
public class Asociacion implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "asociacion_generator")
    @SequenceGenerator(name="asociacion_generator", sequenceName = "sec_asociacion", allocationSize=1)
    ...
    @OneToMany(mappedBy = "idasociacion")
